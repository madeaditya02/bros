    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-56 bg-surface-container-lowest border border-outline rounded-lg shadow-xl z-50 p-4 animate-fade-in text-sm text-on-surface">
            ...
            <div className="pb-3 border-b border-outline-variant mb-2">
              ...
              <p className="text-[10px] text-outline font-semibold tracking-wider mt-1 uppercase">
                admin@roadfix.ai
              </p>
            </div>
